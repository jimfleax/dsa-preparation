...
## Review Scope
- **Files to review**: backend/src/models/Admin.ts, backend/src/controllers/admin/*, backend/src/routes/admin/*, backend/src/middleware/adminAuthMiddleware.ts, backend/server.src.ts, backend/src/types.ts
