    ...
    <div className="flex flex-col flex-1 min-h-[500px] pt-4">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        <div className="bg-white border border-neutral-100 shadow-sm rounded-2xl p-6 flex flex-col relative overflow-hidden group">
          ...
          <div className="relative z-10 flex items-start justify-between">
            <div>
              ...
              <h3 className="text-3xl font-extrabold text-neutral-900">{data.users.total}</h3>
            </div>
        ...
        <div className="bg-white border border-neutral-100 shadow-sm rounded-2xl p-6 flex flex-col relative overflow-hidden group">
          ...
          <div className="relative z-10 flex items-start justify-between">
            <div>
              <p className="text-sm font-bold text-neutral-500 uppercase tracking-wider mb-1">Total Tracks</p>
              <h3 className="text-3xl font-extrabold text-neutral-900">{data.content.totalTracks}</h3>
            </div>
          ...
          <div className="relative z-10 mt-4 flex items-center gap-1.5 text-sm font-medium text-neutral-500">
            <span>{data.content.totalProblemsAvailable} problems available</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-neutral-100 shadow-sm rounded-2xl p-6 flex flex-col relative overflow-hidden group">
          ...
          <div className="relative z-10 flex items-start justify-between">
            <div>
              <p className="text-sm font-bold text-neutral-500 uppercase tracking-wider mb-1">Global Solves</p>
              <h3 className="text-3xl font-extrabold text-neutral-900">{data.engagement.totalProblemsSolvedGlobally}</h3>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white border border-neutral-100 shadow-sm rounded-2xl p-6 md:p-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-lg font-bold text-neutral-900">Most Active Tracks</h3>
          </div>
          <div className="h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={data.engagement.mostActiveTracks} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                />
                <Bar dataKey="activityScore" fill="#6366f1" radius={[4, 4, 0, 0]} barSize={40} name="Activity Score" />
              </BarChart>
            </ResponsiveContainer>
          </div>
        </div>
        ...
        <div className="bg-white border border-neutral-100 shadow-sm rounded-2xl p-6 md:p-8">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-lg font-bold text-neutral-900">Global Completion Rate</h3>
          </div>
          <div className="h-80 w-full">
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
