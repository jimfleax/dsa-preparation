...
export default function UntrackedProblemsModal({
  ...
  return (
    <BaseModal
      isOpen={isOpen}
      onClose={onClose}
      modalId="untracked-problems-modal"
      title="Untracked Problems"
      subtitle="Problems you dismissed from sync"
    ...
    >
      ...
      <div className="px-6 py-3 border-t border-neutral-100 bg-neutral-50 shrink-0 flex justify-between items-center text-[11px] font-medium text-neutral-500 rounded-b-2xl">
        <span>
