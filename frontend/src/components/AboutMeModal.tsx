    ...
    >
      ...
      <div className="p-8 text-center overflow-y-auto">
        ...
        <p className="text-sm text-neutral-600 leading-relaxed mb-8 font-medium">
          I built this tool to structure my own DSA journey and keep track of my
          progress effectively. Seeing it come together, I realized it could be
          just as helpful for fellow developers. I hope it helps you stay
          consistent and crush your preparation!
        </p>
