...
export default function CommandPalette({
  ...
  const searchResults = useMemo(() => {
    ...
    const problems = trackedProblems
      .filter(
        (p) =>
  ...
  const items = useMemo(() => {
    if (isSearchMode) {
      ...
      searchResults.docs.forEach((doc) =>
        result.push({ type: "doc", data: doc }),
      );
      searchResults.problems.forEach((p) =>
        result.push({ type: "problem", data: p }),
      );
      return result;
    } else {
      return [
      ...
      <div className="fixed inset-0 z-[60] pointer-events-none flex p-4 items-center justify-center">
        ...
        >
                  ...
                  {isLoadingCalendar ? (
                    ...
                    <div className="space-y-5">
                      ...
                      <div>
                        ...
                        <p className="text-xl sm:text-2xl font-bold text-neutral-900">
                          <AnimatedNumber value={calendarData.streak} />{" "}
                      ...
                      <div>
                        ...
                        <p className="text-lg sm:text-xl font-bold text-neutral-900">
                          <AnimatedNumber
                            value={calendarData.totalActiveDays}
                          />
                        </p>
                      </div>
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-4 text-neutral-500 h-full">
                      ...
                      <p className="text-xs mb-4">
                        Connect your LeetCode account to view stats.
                      </p>
                      <button
          ...
          <div className="flex flex-col gap-3 items-center w-full">
            ...
            <div
              className={`bg-white border border-neutral-200 rounded-2xl shadow-lg flex flex-col overflow-hidden transition-all duration-300 w-full ${isSearchMode ? "max-w-[600px]" : "max-w-[400px]"}`}
            >
              {/* Search Input */}
              <div className="relative px-4 py-4 border-b border-neutral-100 flex items-center">
                ...
                <div className="flex items-center shrink-0 ml-2 select-none opacity-80 hover:opacity-100 transition-opacity duration-200">
                  <kbd className="bg-neutral-100/90 border border-neutral-200/80 px-1.5 py-0.5 rounded text-[8px] font-mono text-neutral-500 font-semibold shadow-xs leading-none">
                    ESC
                  </kbd>
                </div>
              </div>
                ...
                {isSearchMode ? (
                  <div className="space-y-4 py-2">
                    {searchResults.docs.length > 0 && (
                      <div>
                        <h4 className="text-xs font-semibold text-neutral-400 uppercase tracking-wider px-3 mb-2">
                          Learning Resources
                        </h4>
                        {searchResults.docs.map((doc, index) => {
                          ...
                          return (
                            ...
                            >
                              <div
                                className={`p-2 rounded-lg transition-colors ${
                                  isFocused
                                    ...
                                    : "bg-indigo-100/50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white"
                                }`}
                              >
                              ...
                              <div>
                                <p
                                  className={`text-sm font-semibold transition-colors ${isFocused ? "text-indigo-950" : "text-neutral-900"}`}
                                >
                                  {doc.title}
                                </p>
                              </div>
                        ...
                        {searchResults.problems.map((p, index) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div>
                                <p
                                  className={`text-sm font-semibold transition-colors ${isFocused ? "text-emerald-950" : "text-neutral-900"}`}
                                >
                                  {p.title}
                                </p>
                                <p
                                  className={`text-[11px] transition-colors ${isFocused ? "text-emerald-700/80" : "text-neutral-500"}`}
                                >
                                  {p.difficulty || "Unknown"} • {p.attemptCount}{" "}
                                  attempts
                                </p>
                              </div>
                            </button>
                  ...
                  <div className="py-2 space-y-1">
                    <h4 className="text-xs font-semibold text-neutral-400 uppercase tracking-wider px-3 mb-2 mt-1">
                      Navigation
                    </h4>
                            ...
                            <div className="flex items-center gap-3">
                              <div
                                className={`p-1.5 transition-colors ${
                                  isFocused
                                    ? item.hoverColor
                                    : `text-neutral-500 group-hover:${item.hoverColor}`
                                }`}
                              >
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="text-left">
                      ...
                      <p className="text-[10px] text-neutral-500 mt-0.5 leading-normal">
                        {calendarError ||
                          `We couldn't load stats for "${leetcodeUsername}".`}{" "}
                        Please check settings or connection.
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="p-5 flex-1 w-[230px] flex flex-col justify-center">
                  ...
                  {isLoadingCalendar ? (
                    ...
                    <div className="flex flex-col items-center justify-center text-center py-6 text-neutral-500">
                      ...
                      <p className="text-xs mb-4">
                        Set your LeetCode username to see your activity heatmap
                        here.
                      </p>
                      <button
                        onClick={handleOpenSettings}
